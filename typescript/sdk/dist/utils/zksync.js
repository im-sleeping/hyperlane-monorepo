import { loadAllZKSyncArtifacts } from '@hyperlane-xyz/core';
/**
 ...
 */
export const getZKSyncArtifactByContractName = async (name) => {
    ...
    const artifact = Object.values(allArtifacts).find(({ contractName, sourceName }) => {
