...
export async function getValidatorFromStorageLocation(location) {
...
export function isValidValidatorStorageLocation(location) {
    return (location?.startsWith(GCP_LOCATION_PREFIX) ||
