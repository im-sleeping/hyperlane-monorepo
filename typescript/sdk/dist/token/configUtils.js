...
import { ProtocolType, addressToBytes32, intersection, isAddressEvm, isCosmosIbcDenomAddress, objFilter, objMap, promiseObjAll, sortArraysInObject, transformObj, } from '@hyperlane-xyz/utils';
...
import { ContractVerificationStatus, } from './types.js';
/**
...
export function transformConfigToCheck(obj) {
    ...
    return sortArraysInObject(transformObj(filteredObj, transformWarpDeployConfigToCheck), sortArraysInConfigToCheck);
}
/**
