...
import { ERC20Test__factory, ProxyAdmin__factory, TransparentUpgradeableProxy__factory, XERC20Test__factory, } from '@hyperlane-xyz/core';
    ...
    for (const type of [
        ...
        describe('HypERC20Checker', async () => {
            ...
            it('should output "collateralToken" violation when ownerOverrides.collateralToken is set', async () => {
                ...
                const checkerWithOwnerOverrides = new HypERC20Checker(multiProvider, app, configWithOverrides);
                await xerc20.transferOwnership(ethers.Wallet.createRandom().address);
