...
export class CcipReadMetadataBuilder {
    type = IsmType.CCIP;
    core;
    constructor(core) {
        this.core = core;
        ...
        for (const urlTemplate of urls) {
            ...
            try {
                ...
                if (urlTemplate.includes('{data}')) {
                    ...
                    const messageHash = utils.solidityKeccak256(['string', 'address', 'bytes', 'string'], ['HYPERLANE_OFFCHAINLOOKUP', sender, callDataHex, urlTemplate]);
