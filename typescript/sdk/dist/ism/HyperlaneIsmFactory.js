import { AmountRoutingIsm__factory, ArbL2ToL1Ism__factory, CCIPIsm__factory, DefaultFallbackRoutingIsm__factory, DomainRoutingIsm__factory, IAggregationIsm__factory, IInterchainSecurityModule__factory, IMultisigIsm__factory, InterchainAccountIsm__factory, OPStackIsm__factory, PausableIsm__factory, StorageAggregationIsm__factory, StorageMerkleRootMultisigIsm__factory, StorageMessageIdMultisigIsm__factory, TestIsm__factory, TrustedRelayerIsm__factory, } from '@hyperlane-xyz/core';
...
export class HyperlaneIsmFactory extends HyperlaneApp {
    ...
    async deployIcaIsm(params) {
        if (!params.mailbox) {
            throw new Error('Mailbox address is required for deploying ICA ISM');
        }
        return this.multiProvider.handleDeploy(params.destination, new InterchainAccountIsm__factory(), [params.mailbox]);
    }
